...
public class AlarmVO {
	...
	/**
	 * 告警类型: 1. 通信告警 2：设备告警 3：处理出错告警 4：业务质量告警 5：环境告警 6：完整性告警 7：操作告警 8：物力资源告警 9：安全告警
	 * 10：时间域告警
	 */
	...
	/**
	 * 告警级别： 0：不确定 1：紧急 2：重要 3：次要 4：提示
	 */
	...
	public AlarmVO(String alarmSN, String alarmName, Long startTime, Long endTime, String alarmSource, String location,
			...
			Integer clearedType, Long commentTime, String commentUser, String comments, Integer devCsn, Long eventTime,
			Integer eventType, Long lastestLogTime, String moDn, String moName, String neDN, String neName,
			String neType, String objectInstance, Integer perceivedSeverity, Integer probableCause,
			String probableCauseStr, String proposedRepairActions, String alarmGroupId) {
